...
export const pricingPlans: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: '🌐 Subdominio .msl.mx incluido', included: true },
      { text: '🔧 Mantenimiento gratuito', included: true },
      { text: '📝 Sistema de Blog completo', included: true }, 
  ...
  },
  {
    ...
    features: [
      ...
      { text: '📝 Sistema de Blog completo', included: true }, 
      { text: '⚡ Listo en 24 horas máximo', included: true, highlighted: true },
      { text: '🛒 Tienda Online completa + Pagos', included: true, highlighted: true },
      { text: '📧 Correo Electrónico profesional (10 cuentas)', included: true },    
      { text: '⚙️ Panel de Control avanzado + Analytics', included: true },
      { text: '🎯 Dominio personalizado gratis + SSL', included: true }
    ],
    buttonText: 'Comprar Ahora',
